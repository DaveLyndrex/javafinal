...
public class UpdateAdmin extends javax.swing.JFrame {
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        try {
            ...
            String query = "UPDATE admins SET firstname='" + this.inputFirstname.getText() + "', lastname='" + this.inputLastname.getText() + "', username='" + this.inputUsername.getText() + "', password ='"+this.inputPassword.getText()+"' WHERE admin_id='" + this.admin_id.getText() + "'";
            stmt.execute(query);
    ...
    public static javax.swing.JLabel admin_id;
